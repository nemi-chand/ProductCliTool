...
{
    public class SoftwareAdviceCommandHandler : ICommandHandler
    {
        private readonly IProductImporter _productImporter;

        public SoftwareAdviceCommandHandler(Func<string, IProductImporter> productImporterFactory)
        {
            _productImporter = productImporterFactory("softwareadvice");
        }
